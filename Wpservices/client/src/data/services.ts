    ...
    categories: [
      {
        ...
        services: [
          item({
            ...
            faqs: [
              { q: "What is included in WordPress maintenance?", a: "Updates, daily backups, security and uptime monitoring, bug fixes, and a monthly report. We confirm the exact mix for your site." },
              { q: "What happens if an update breaks the site?", a: "We isolate the change, roll it back if needed, and restore a working site first. Then we fix the conflict in a controlled way." },
              { q: "Do you back up the site before changes?", a: "Yes. Daily offsite backups are part of ongoing care, plus a restore point before significant updates." },
              { q: "How fast do you respond to downtime?", a: "Monitoring often alerts us before customers notice. Every plan has a named technical owner — not a generic ticket queue." },
            ],
          }),
        ],
      },
